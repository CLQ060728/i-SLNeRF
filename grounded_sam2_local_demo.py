...
#     np.savetxt(os.path.join(OUTPUT_DIR, f"mask_{mask_id}.npy"), masks[mask_id])
"""
...
# cv2.imwrite(os.path.join(OUTPUT_DIR, f"{file_name}_bbox.jpg"), annotated_frame)

mask_annotator = sv.MaskAnnotator()
annotated_frame = mask_annotator.annotate(scene=img.copy(), detections=detections)
# annotated_frame = mask_annotator.annotate(scene=annotated_frame, detections=detections)
cv2.imwrite(os.path.join(OUTPUT_DIR, f"{file_name}_mask.jpg"), annotated_frame)
