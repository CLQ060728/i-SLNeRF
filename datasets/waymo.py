...
class WaymoPixelSource(ScenePixelSource):
    ...
    def load_calibrations(self):
        ...
        _intrinsics = []
        cam_to_egos = []
        for i in range(self.num_cams): # first adapting intrinsics for each of the cameras
        ...
        # compute ego_to_world and cam_to_world for each timestep frame
        for t in range(self.start_timestep, self.end_timestep): 
            ...
            for cam_id in self.camera_list: # adapt cam_to_worlds and intrinsics for each of the cameras
        ...
        # stack all the matrices per camera
    ...
    def render_data_videos(
        ...
        for i in trange(
            ...
            if "depth_maps" in data_dict:
                ...
                depth_maps.append(all_depth_maps)
