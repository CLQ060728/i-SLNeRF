...
#####################################rendering functions#####################################
def rendering_geometry(weights, trans, t_starts, t_ends, results, return_decomposition):
    extras = {
        "weights": weights,
    ...
    if "static_density" in results and "dynamic_density" in results:
        ...
        if return_decomposition:
            ...
            static_weights = dynamic_weights = None

    return static_ratio, static_weights, dynamic_ratio, dynamic_weights, extras, results_dict


def rendering_rgb(results, weights, static_ratio, static_weights,
...
def rendering_semantic_features(results, weights, static_ratio, static_weights,
                                dynamic_ratio, dynamic_weights, results_dict, return_decomposition):
    if "static_semantic_embedding" in results and "dynamic_semantic_embedding" in results and \
        ...
        if "semantic_embedding" in results and "selection_mask" in results:
            results_dict["selection_mask"] = accumulate_along_rays(
                weights,
